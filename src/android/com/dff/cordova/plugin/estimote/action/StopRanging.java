...
public class StopRanging extends EstimoteAction {
	public static final String LOG_TAG = "com.dff.cordova.plugin.estimote.action.StopRanging";
	public static final String ACTION_NAME = "stopRanging";

	public StopRanging(String action, JSONArray args, CallbackContext callbackContext, CordovaInterface cordova,
	...
	public void run() {
		...
		try {
			...
			if (jsonArgs != null) {
				...
				CordovaPluginLog.d(LOG_TAG, "stopRanging: " + region.toString());				
